	...
	<section class="top-service">
		<div class="container">
			<div class="serviceBox">
				...
				<p class="serviceBox_text">記憶に刷込み、興味を引き認知度・商圏範囲を広げます。<br>『潜在顧客』から『お客様』に変わるきっかけとなります。</p>
				<div class="button-more">
	...
	<section class="top-service is-ad">
		<div class="container">
			<div class="serviceBox">
				...
				<p class="serviceBox_text">交通量や人の流れが多い場所に随時追加設置しております。<br>空いて間もなく・新設したばかりの新着情報もお見逃しなく。</p>
				<div class="button-more">
	...
	<section class="top-other">
		<div class="otherArea">
			...
			<div class="otherAreaBox is-border-left">
				...
				<div class="button-more">
					<a href="<?php echo $masterLink; ?>/service/rent-land/"><span>Read more</span></a>
				</div>
				<div class="thumbnail">
