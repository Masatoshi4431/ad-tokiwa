...
<main class="top">
		...
		<div class="mainvisualMovie">
			<div class="mainvisualMovie_inner">
				<video class="js-movie" webkit-playsinline playsinline muted loop>
					<source src="https://ad-tokiwa.jp/wp-content/uploads/2021/11/tokiwa-movie.mp4">
				</video>
			</div>
		</div>
	...
	<section class="top-service">
		<div class="container">
			...
			<div class="serviceBox_img is-sp">
				<img src="<?php echo get_template_directory_uri(); ?>/assets/images/top/service_bg_1.jpg" alt="">
			</div>
		</div>
	</section>
	...
	<section class="top-service is-ad">
		<div class="container">
			...
			<div class="serviceBox_img is-sp">
				<img src="<?php echo get_template_directory_uri(); ?>/assets/images/top/service_bg_2.jpg" alt="">
			</div>
		</div>
	</section>
	...
	<section class="top-service is-production">
		<div class="container">
			...
			<div class="serviceBox_img is-sp">
				<img src="<?php echo get_template_directory_uri(); ?>/assets/images/top/service_bg_3.jpg" alt="">
			</div>
		</div>
	</section>
