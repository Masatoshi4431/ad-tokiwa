...
<main class="main service other-service js-headerMain js-target-area">
	...
	<section class="section">
		<div class="section_inner">
			<div class="heading">
				<p class="text-center">常磐広告では各部門に精通したスタッフが在籍しており、看板に関わる全てのサービスを提供しております。<br>看板のメンテナンス、点検、撤去、移設から屋外広告物申請代行、看板用地交渉、電気工事、デザイン、出力等幅広くご対応させていただきます。<br>また、外注先や業務提携先をお探しの企業様のお手伝いも承っております。</p>	
			</div>
		</div>	
	</section>
