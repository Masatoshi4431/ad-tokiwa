...
<main class="main service other-service js-headerMain">
	...
	<section class="section">
		<div class="section_inner">
			<div class="heading">
				<p class="text-center">弊社では各部門に精通したスタッフが在籍しており、看板にかかわる全てのサービスを提供しております。メンテナンス、点検、看板撤去・移設から屋外広告物申請代行、看板用地交渉、電気申請、デザイン、出力等幅広くご対応させていただきます。また、外注先や業務提携先をお探しの企業様のお手伝いも承っております。</p>	
			</div>
		</div>	
	</section>
