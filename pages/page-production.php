...
<main class="main service production js-headerMain">
	...
	<section class="section">
		<div class="section_inner">
			<div class="heading">
				<p class="text-center">常磐広告ではロードサインだけではなく、看板に関わる全てのサービスを提供しております。<br>会社や店舗、施設等に関する看板から個人のお客様の一枚のステッカーまで幅広く対応させていただきます。<br>まずは専門のスタッフが現地にお伺いし、ヒアリングからお見積り、ご提案までを全て無料にてご利用いただけます。<br>看板に関するご相談、お困りごとはお気軽にご相談下さい。</p>
			</div>
		</div>	
	</section>
		...
		<div class="section_inner">
			...
			<div class="servicePostMore">
				<div class="button-more">
					<a href="<?php echo $masterLink; ?>/works/production/"><span>Read more</span></a>
				</div>
			</div>
		</div>
	</section>
