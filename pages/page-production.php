...
<main class="main service production js-headerMain js-target-area">
	...
	<section class="section">
		<div class="section_inner">
			<div class="heading">
				<p class="text-center">常磐広告ではロードサインだけではなく、看板に関わる全てのサービスを提供しております。<br>会社や店舗、施設等に関する看板から個人のお客様の一枚のステッカーまで幅広く対応させていただきます。<br>まずは専門のスタッフが現地にお伺いし、ヒアリングからお見積り、ご提案までを全て無料にてご利用いただけます。</p>
			</div>
		</div>	
	</section>
