...
<main class="main service road-sign js-headerMain">
	...
	<section class="section">
		<div class="section_inner">
			<div class="heading">
				<p class="text-center">常磐広告の強みは、ロードサインを設置する場所の交渉力と多方向から誘客する為の提案力です。<br>お客様からのリクエストを元に交渉をし、ロードサイン を設置する事ももちろん、<br class="is-pc">希少な場所や交通量が多い主要道路には積極的に新規設置をしております。</p>
			</div>
		</div>	
	</section>
