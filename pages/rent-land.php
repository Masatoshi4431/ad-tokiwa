...
<main class="main rentLand js-headerMain js-target-area">
	...
	<section class="section">
		<div class="section_inner">
			<div class="heading">
				<p class="text-center">空きスペースを有効活用して収益にしませんか？<br>地主様には毎年、看板設置使用料を一括前払いにてお支払いいたします。<br>弊社専門のスタッフが現地を確認し最適なサイズ、賃料をご提示させていただきます。<br>設置やメンテナンス、退去時の撤去まで一貫して弊社が責任を持って行います。<br>万が一の保険や面倒な行政手続き、看板の管理も安心してお任せください。</p>			
			</div>
		</div>	
	</section>
